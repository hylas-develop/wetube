    ...
    return regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 9:
            filePath = video.fileUrl.split("/video/")[1];
            delFile = {
              Bucket: "hylas-wetube/video",
              Key: filePath
            };
            _context7.next = 13;
            return _middlewares.s3.deleteObject(delFile, function (err, _) {
              if (err) console.log(err);else console.log("The file has been removed");
            }).promise();
...
var postAddComment = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(req, res) {
    var commentObject, id, comment, user, video, newComment;
